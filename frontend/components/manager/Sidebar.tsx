      ...
      <div className="p-8 border-t border-[#E2E8F0]">
        {!collapsed ? (
          <div className="flex items-center gap-4 p-4 rounded-3xl bg-[#F8FAFC] border border-[#E2E8F0]">
            <div className="w-12 h-12 bg-[#EDF2F7] rounded-xl flex items-center justify-center text-sm font-black text-[#1A2A3A] shadow-sm">M</div>
            <div className="flex-1 overflow-hidden">
              <p className="text-sm font-bold text-[#1A2A3A] truncate">Manager Suite</p>
              <p className="text-[11px] text-[#64748B] font-bold tracking-widest uppercase mt-1">Enterprise</p>
            </div>
          </div>
        ) : (
          <div className="w-12 h-12 bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl flex items-center justify-center text-sm font-black text-[#1A2A3A] mx-auto">M</div>
        )}
      </div>
    </aside>
  )
