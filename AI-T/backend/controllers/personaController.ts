...
Return ONLY a valid JSON object matching this exact structure:
{
  ...
  "personality_traits": "string (5-7 bullet points starting with '- ', describing the prospect in the third person, e.g. '- The prospect is highly analytical.\\n- Very impatient with long answers.')",
  "communication_style": "string (3-5 bullet points starting with '- ', describing how the prospect speaks and communicates in the third person, e.g. '- Speaks very fast.\\n- Interrupts frequently.')",
  "objection_style": "string (3-5 bullet points starting with '- ', explaining how they object with examples, in the third person, e.g. '- Frequently objects on price.\\n- Says: \"We can build it cheaper in-house.\"')",
  "decision_drivers": "string (3-5 bullet points starting with '- ', explaining what influences their decisions and why)",
